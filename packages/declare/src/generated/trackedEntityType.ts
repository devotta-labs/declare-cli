...
import { z } from 'zod'
import { FeatureType_2_40, FeatureType_2_41, FeatureType_2_42, FeatureType_2_43 } from './enums.ts'
...
export const TrackedEntityTypeBase_2_43 = z.object({
  allowAuditLog: z.boolean().optional(),
  code: z.string().max(50).optional(),
  description: z.string().optional(),
  enableChangeLog: z.boolean().optional(),
...
export const TrackedEntityTypeBaseByTarget = {
  ...
  '2.43': TrackedEntityTypeBase_2_43,
} as const
